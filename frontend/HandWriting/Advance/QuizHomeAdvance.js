...
export default function QuizHomeAdvance() {
      ...
      <View style={style.container}>
        <View style={style.catregoryContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("MainWritingPageAdvance", { category: "Adjectives" })
            }
          >
          ...
          <TouchableOpacity
            style={style.category}
            onPress={() =>
              navigation.navigate("MainWritingPageAdvance", { category: "Noun" })
            }
          >
          ...
          <TouchableOpacity
            style={style.category}
            onPress={() =>
              navigation.navigate("MainWritingPageAdvance", { category: "Verbs" })
            }
          >
          ...
          <TouchableOpacity
            style={style.category}
            onPress={() =>
              navigation.navigate("MainWritingPageAdvance", { category: "Adverbs" })
            }
          >
