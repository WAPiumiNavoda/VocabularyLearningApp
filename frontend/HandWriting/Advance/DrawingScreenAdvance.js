...
const DrawingScreenAdvance= ({ navigation, route }) => {
  ...
  const predictCharacter = async (uri) => {
    try {
      ...
      navigation.navigate("PlayGroundAdvance", { drawnCharacter: data.predicted_character, wordIndex });
...
export default DrawingScreenAdvance;
