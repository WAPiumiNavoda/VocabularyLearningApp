...
const TaskMainIntermediatePage = () => {
  ...
  const predictKeyword = async () => {
    ...
    try {
      ...
      navigation.navigate('MainScreenIntermediate', { predictedKeyword : result.predicted_keyword  });
    } catch (error) {
...
export default TaskMainIntermediatePage;
