...
export default function VoiceQuizAppAdvance() {
      ...
      <View style={style.container}>
        <View style={style.catregoryContainer}>
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('MainScreenAdvance', { category: 'Fruits' })}
          >
          ...
          <TouchableOpacity 
            style={style.category}
            onPress={() => navigation.navigate('MainScreenAdvance', { category: 'Commands' })}
          >
